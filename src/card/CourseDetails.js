        ...
        <div className=" grid grid-rows-2 grid-cols-1 lg:grid-cols-2 gap-4 ">
          <div className="row-span-2">
            ...
            <div className="border-2 border-[black] py-5">
              <h1 className="text-2xl font-bold py-2 px-5">
                Why You Enroll This Course
              </h1>
              <ul className="list-disc p-5">
                <li>
                  To gain new skills or knowledge: This course can help you
                  learn new skills or knowledge in a specific area, which can be
                  beneficial for personal or professional development.
                </li>
                <li>
                  To advance your career: Taking this course can help you
                  advance your career by increasing your expertise in a certain
                  field or by helping you qualify for new job opportunities.
                </li>
                <li>
                  To meet new people: Courses often bring together a diverse
                  group of people who have a common interest. This can be a
                  great opportunity to meet new people and expand your network.
                </li>
              </ul>
              <h5 className="p-2">
                Overall, there are many reasons to consider taking this course,
                and the specific reasons will depend on your individual goals
                and interests.
              </h5>
            </div>
            ...
            <div className="flex shadow rounded p-5 ">
              ...
              <div className="w-2/3 ">
                <p className="hover:text-five  pointer">
